...
export function debugImage (element,noBorders){
...
export function debug (el,options){
...
export function watch (target, property, options, callback) {
...
export function getObservableArrayProto(){
    var _array = [],
      _handlers = {
        itemadded: [],
        itemremoved: [],
