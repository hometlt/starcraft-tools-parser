...
await mod.read("../data-input/0.Core.SC2Mod")
await mod.read("../data-input/1.Liberty.SC2Mod")
await mod.read("../data-input/4.Swarm.SC2Mod")
await mod.read("../data-input/7.Void.SC2Mod")
await mod.read("../data-input/9.Void Multi.SC2Mod")
